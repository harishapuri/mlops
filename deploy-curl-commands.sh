...
docker tag bike_share_model_inference gcr.io/startwithgcp/bike_share_model_inference

docker push gcr.io/startwithgcp/bike_share_model_inference

gcloud run deploy bikeshare-model-inference --image  gcr.io/startwithgcp/bike_share_model_inference --region us-central1
